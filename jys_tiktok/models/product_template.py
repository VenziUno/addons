...
class ProductTemplate(models.Model):
    ...
    tiktok_brand_id = fields.Many2one('tiktok.brand','Tiktok Brand')
    tiktok_category_id = fields.Many2one('tiktok.category','Tiktok Category')
    tiktok_warehouse_id = fields.Many2one('tiktok.warehouse', 'Tiktok Warehouse')

    pack_dimension_unit = fields.Selection([
        ('CENTIMETER','CENTIMETER'),
        ('INCH','INCH')
    ], 'Unit', default='CENTIMETER')
    tiktok_height = fields.Char('Height')
    tiktok_width = fields.Char('Width')
    tiktok_length = fields.Char('Length')

    pack_weight_unit = fields.Selection([
        ('KILOGRAM','KILOGRAM'),
        ('POUND','POUND')
    ], 'Unit', default='KILOGRAM')
    pack_weight_value = fields.Char('Value')
